 ...
 * @LastEditTime: 2021-11-23 16:05:58
 * @LastEditors: 徐庆凯
 * @Description:
...
import MicroStateActions from './micro/MicroStateActions'
...
export async function mount(props: any) {
  props.onGlobalStateChange((state: any, prev: any) => {
    MicroStateActions.onGlobalStateChange(state, prev)
  })
  MicroStateActions.setActions(props)
  render(props)
}
